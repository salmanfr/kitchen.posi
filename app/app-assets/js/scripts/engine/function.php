...
function convertVoucher($number){
    if($number=='1'){
      return array('kontext'=>'Paket Planet (100 Atom)',
                   'atom'=>'100',
                   'bonus'=>'0',
                   'harga'=>'100000');
    }
    else if($number=='2'){
      return array('kontext'=>'Paket Galaxy (2000 Atom + Bonus 5 Atom)',
                   'atom'=>'2000',
                   'bonus'=>'5',
                   'harga'=>'2000000');
    }
    else if($number=='3'){
      return array('kontext'=>'Paket Tata Surya (1000 Atom + Bonus 2 Atom)',
                   'atom'=>'1000',
                   'bonus'=>'2',
                   'harga'=>'1000000');
    }
    else if($number=='4'){
      return array('kontext'=>'Paket Matahari (500 Atom + Bonus 1 Atom)',
                   'atom'=>'500',
                   'bonus'=>'1',
                   'harga'=> '500000');
    }
